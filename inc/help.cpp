...
void about(int scr)
{
  ...
  char s[100][100];
  strcpy (s[0],"AUTHOR");
  strcpy (s[1],"    Alexandru Radovici - alex@ipworkshop.ro");
  strcpy (s[2],"");
  strcpy (s[3],"VERSION");
