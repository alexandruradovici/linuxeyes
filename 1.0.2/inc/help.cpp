...
/*    initscr();
  ...
  strcpy (s[23],"email me. (linuxeyes@lug.orizont.net) Thank you!");
  strcpy (s[24],"");
  strcpy (s[25],"LOTS OF THANKS TO");
  strcpy (s[26],"    Vera and Iuliu Radovici");
  strcpy (s[27],"    Cosmin Chertes");
  strcpy (s[28],"    Ovidiu Stoica - oviska@hotmail.com");
  strcpy (s[29],"    Alexandru Armean - alex@lug.orizont.net");
  strcpy (s[30],"    Valeriu Moldovan - valeriu_moldovan@hotmail.com");
  strcpy (s[31],"    Cristian Klein - cristiklein@yahoo.com");
  strcpy (s[32],"");
