...
/*    initscr();
  ...
  strcpy (s[2],"");
  strcpy (s[3],"VERSION");
  strcpy (s[4],"    LinuxEyes 0.3, build 2 (October 18, 2001)");
  strcpy (s[5],"");
  strcpy (s[6],"ECLIPSE");
...
void help(int scr)
{
  ...
  strcpy (s[40]," i            : Song Information (id3 tag)");
  strcpy (s[41]," e            : Edit playlist file entry");
  strcpy (s[42]," j            : Jump to file");
  strcpy (s[43]," n            : Refresh list");
  strcpy (s[44]," 0            : On/Off Shut Down mode");
  strcpy (s[45]," q            : Quit");
  strcpy (s[46],"");
  strcpy (s[47],"PLAYER MODES");
  strcpy (s[48]," Normal       : Next song in playlist");
  strcpy (s[49]," Shuffle      : Random next song");
  strcpy (s[50]," Next Song    : Next song already selected");
  strcpy (s[51]," Shut Down    : Shut Down after next song");
  WINDOW *w1;
  w1=newwin (scr+2,62,7,9);
  wrefresh (w1);
  werase (w1);
