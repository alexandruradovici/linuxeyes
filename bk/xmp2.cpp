...
/*list_type keys_names = { //list of function's names
    "Enter",
    "ESC",
    "Up",
    "Down",
...
{
//  LElist lista_taste (keys_names, nr_keys, "Define Keys", 8);
//  if (scr > nr_keys+2) scr=nr_keys+2;
//  lista_taste.show (scr);
}
