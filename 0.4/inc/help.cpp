...
/*    initscr();
  ...
  strcpy (s[2],"");
  strcpy (s[3],"VERSION");
  strcpy (s[4],"    LinuxEyes 0.4, build 1 (November 10, 2001)");
  strcpy (s[5],"");
  strcpy (s[6],"ECLIPSE");
  ...
  strcpy (s[15],"");
  strcpy (s[16],"UPDATE");
  strcpy (s[17],"    http://nike.lem.uttgm.ro/eclipse/linuxeyes");
  strcpy (s[18],"");
  strcpy (s[19],"BUGS & SUGGESTIONS");
  strcpy (s[20],"    If you find any bugs or have any suggestion please");
  strcpy (s[21],"e-mail me. (alex_amysoft@hotmail.com)");
  WINDOW *w1;
...
void help(int scr)
{
  ...
  strcpy (s[40]," +            : Increase Playlist");
  strcpy (s[41]," -            : Decrease Playlist");
  strcpy (s[42]," i            : Song Information (id3 tag)");
  strcpy (s[43]," e            : Edit playlist file entry");
  strcpy (s[44]," j            : Jump to file");
  strcpy (s[45]," n            : Refresh list");
  strcpy (s[46]," 0            : On/Off Shut Down mode");
  strcpy (s[47]," q            : Quit");
  strcpy (s[48],"");
  strcpy (s[49],"PLAYER MODES");
  strcpy (s[50]," Normal       : Next song in playlist");
  strcpy (s[51]," Shuffle      : Random next song");
  strcpy (s[52]," Next Song    : Next song already selected");
  strcpy (s[53]," Shut Down    : Shut Down after next song");
  WINDOW *w1;
  w1=newwin (scr+2,62,7,9);
  wrefresh (w1);
  werase (w1);
